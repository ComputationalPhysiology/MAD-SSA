...
# seg_dir = "/home/shared/Segmentations_ES"
# case = "31"
def get_rv_point(seg_dir, case):
    rvmask,resolution_data = read_rvdata_h5(os.path.join(seg_dir ,f"{case}_original_segmentation.h5"))
...
print(get_rv_point("/home/shared/Segmentations_ES","11"))