...
def load_original_data(sample_directory):
    ...
    LVmask = ventricshape.meshing_utils.close_apex(LVmask_raw)
    ...
    if mode_flag:
        ...
        for i, mode in enumerate(selected_modes):
            ...
            if delauny_flag:
                ...
                vertices_epi, faces_epi = ventricshape.meshing_utils.create_mesh_slice_by_slice(points_cloud_epi, scale=1.5)
                vertices_endo, faces_endo = ventricshape.meshing_utils.create_mesh_slice_by_slice(points_cloud_endo, scale=1.5)
